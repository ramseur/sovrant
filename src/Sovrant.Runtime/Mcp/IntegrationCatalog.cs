...
public static class IntegrationCatalog
{
    ...
    [
        // Automation (HTTP MCP)
        new("composio", "Composio", "Automation", "link",
        ...
        new("n8n", "n8n", "Automation", "workflow",
        ...
        new("zapier", "Zapier", "Automation", "integrations",
        ...
        new("make", "Make", "Automation", "refresh",
        ...
        // Platform (stdio MCP)
        new("github", "GitHub", "Platform", "git-branch",
        ...
        new("slack", "Slack", "Platform", "message",
        ...
        new("notion", "Notion", "Platform", "document",
        ...
        new("linear", "Linear", "Platform", "kanban",
        ...
        new("stripe", "Stripe", "Platform", "credit-card",
        ...
        new("postgres", "PostgreSQL", "Platform", "database",
        ...
        new("supabase", "Supabase", "Platform", "database-zap",
        ...
        new("snowflake", "Snowflake", "Platform", "snowflake",
        ...
        // Search
        new("brave-search", "Brave Search", "Search", "search",
        ...
        new("tavily", "Tavily", "Search", "globe",
        ...
        // DXP / CMS / Data
        new("sitecore-community", "Sitecore", "DXP", "layers",
        ...
        new("sitecore-marketer", "Sitecore", "DXP", "layers",
        ...
        new("aem", "Adobe Experience Manager", "DXP", "panel",
        ...
        new("optimizely-experimentation", "Optimizely", "DXP", "chart",
        ...
        new("optimizely-cms", "Optimizely", "DXP", "chart",
